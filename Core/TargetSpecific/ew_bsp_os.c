...
*
*******************************************************************************/
unsigned long int EwBspOsSignalWait( unsigned int aSignalFlags, unsigned int aTimeout )
{
	osEvent Event;
	Event = osSignalWait( aSignalFlags, aTimeout );
	return Event.value.signals;
}
...
*
*******************************************************************************/
unsigned long int EwBspOsSignalSet( XThreadHandle aThreadHandle, unsigned int aSignalFlags )
{

  return osSignalSet( aThreadHandle, aSignalFlags );
}
...
{
  return osSemaphoreWait( aHandle, aTimeout ) == osOK ? 1 : 0;
}
