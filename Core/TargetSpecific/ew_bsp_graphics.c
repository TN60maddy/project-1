...
#if defined STM32H735xx || STM32H743xx || STM32H753xx || defined STM32H745xx || defined STM32H747xx || defined STM32H750xx || defined STM32H7B3xxQ
...
#include "ew_bsp_os.h"
  ...
  static XSemaphoreHandle  AcceleratorSemaphoreId;
...
void EwBspGraphicsDone( void )
{
  ...
  HAL_DMA2D_DeInit( &Accelerator );
    ...
    EwBspOsSemaphoreDestroy( AcceleratorSemaphoreId );
...
void DMA2D_IRQHandler( void )
{
  ...
  if ( Accelerator.State == HAL_DMA2D_STATE_READY )
  {
      ...
      EwBspOsSemaphoreRelease( AcceleratorSemaphoreId );
