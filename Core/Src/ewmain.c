...
static XEnum EwGetKeyCommand( void )
{
    ...
    switch ( EwBspConsoleGetCharacter())
    {
      ...
      case 0x0D : EwPrint("Key 'Enter' pressed\n"); return CoreKeyCodeEnter;
      case 0x20 : EwPrint("Key 'Space' pressed\n"); return CoreKeyCodeSpace;
...
void EwPrintSystemInfo( void )
{
  ...
  EwPrint( "External Flash memory                        %s      \n", PRINT_ENABLED( EW_USE_EXTERNAL_FLASH == 1 ));
