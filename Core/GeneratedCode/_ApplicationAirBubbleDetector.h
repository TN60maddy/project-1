...
#ifndef _ApplicationAirBubbleDetector_H
#define _ApplicationAirBubbleDetector_H
...
/* Forward declaration of the class Application::AirBubbleDetector */
#ifndef _ApplicationAirBubbleDetector_
  EW_DECLARE_CLASS( ApplicationAirBubbleDetector )
#define _ApplicationAirBubbleDetector_
#endif
...
/* Deklaration of class : 'Application::AirBubbleDetector' */
EW_DEFINE_FIELDS( ApplicationAirBubbleDetector, ApplicationSettingsPage )
  EW_OBJECT  ( SingleBubbleThresholdItem, ComponentsIntSettingItem )
  EW_OBJECT  ( CumulativeBubbleThresholdItem, ComponentsIntSettingItem )
EW_END_OF_FIELDS( ApplicationAirBubbleDetector )

/* Virtual Method Table (VMT) for the class : 'Application::AirBubbleDetector' */
EW_DEFINE_METHODS( ApplicationAirBubbleDetector, ApplicationSettingsPage )
...
EW_END_OF_METHODS( ApplicationAirBubbleDetector )

#ifdef __cplusplus
  }
#endif

#endif /* _ApplicationAirBubbleDetector_H */
