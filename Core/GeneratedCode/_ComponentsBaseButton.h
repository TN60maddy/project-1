...
#ifndef _ComponentsBaseButton_H
#define _ComponentsBaseButton_H
...
/* Forward declaration of the class Components::BaseButton */
#ifndef _ComponentsBaseButton_
  EW_DECLARE_CLASS( ComponentsBaseButton )
#define _ComponentsBaseButton_
#endif
...
EW_DEFINE_FIELDS( ComponentsBaseButton, TemplatesPushButton )
  ...
  EW_PROPERTY( BgColorPressed,  XColor )
  EW_PROPERTY( BgColorDisabled, XColor )
EW_END_OF_FIELDS( ComponentsBaseButton )

/* Virtual Method Table (VMT) for the class : 'Components::BaseButton' */
EW_DEFINE_METHODS( ComponentsBaseButton, TemplatesPushButton )
...
EW_END_OF_METHODS( ComponentsBaseButton )
