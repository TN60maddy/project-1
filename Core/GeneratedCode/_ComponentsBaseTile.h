...
#ifndef _ComponentsBaseTile_H
#define _ComponentsBaseTile_H
...
/* Forward declaration of the class Components::BaseTile */
#ifndef _ComponentsBaseTile_
  EW_DECLARE_CLASS( ComponentsBaseTile )
#define _ComponentsBaseTile_
#endif
...
/* Deklaration of class : 'Components::BaseTile' */
EW_DEFINE_FIELDS( ComponentsBaseTile, ComponentsBaseButton )
  ...
  EW_PROPERTY( ValueFont1,      ResourcesFont )
...
EW_END_OF_FIELDS( ComponentsBaseTile )

/* Virtual Method Table (VMT) for the class : 'Components::BaseTile' */
EW_DEFINE_METHODS( ComponentsBaseTile, ComponentsBaseButton )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsBaseTile _this, XSet aState )
...
EW_END_OF_METHODS( ComponentsBaseTile )
