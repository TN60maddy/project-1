...
#ifndef _ComponentsEditTileTime_H
#define _ComponentsEditTileTime_H
...
/* Forward declaration of the class Components::EditTileTime */
#ifndef _ComponentsEditTileTime_
  EW_DECLARE_CLASS( ComponentsEditTileTime )
#define _ComponentsEditTileTime_
#endif
...
/* Deklaration of class : 'Components::EditTileTime' */
EW_DEFINE_FIELDS( ComponentsEditTileTime, ComponentsEditTile )
EW_END_OF_FIELDS( ComponentsEditTileTime )

/* Virtual Method Table (VMT) for the class : 'Components::EditTileTime' */
EW_DEFINE_METHODS( ComponentsEditTileTime, ComponentsEditTile )
  ...
  EW_METHOD( Save,              void )( ComponentsEditTile _this )
EW_END_OF_METHODS( ComponentsEditTileTime )
...
#endif /* _ComponentsEditTileTime_H */
