...
#ifndef _ComponentsRoundTextButton_H
#define _ComponentsRoundTextButton_H
...
/* Forward declaration of the class Components::RoundTextButton */
#ifndef _ComponentsRoundTextButton_
  EW_DECLARE_CLASS( ComponentsRoundTextButton )
#define _ComponentsRoundTextButton_
#endif
...
/* Deklaration of class : 'Components::RoundTextButton' */
EW_DEFINE_FIELDS( ComponentsRoundTextButton, ComponentsRoundButton )
  EW_OBJECT  ( CaptionText,     ViewsText )
  EW_PROPERTY( Font,            ResourcesFont )
  EW_PROPERTY( Caption,         XString )
  EW_PROPERTY( CaptionColor,    XColor )
EW_END_OF_FIELDS( ComponentsRoundTextButton )

/* Virtual Method Table (VMT) for the class : 'Components::RoundTextButton' */
EW_DEFINE_METHODS( ComponentsRoundTextButton, ComponentsRoundButton )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsRoundTextButton _this, XSet aState )
...
EW_END_OF_METHODS( ComponentsRoundTextButton )
...
#endif /* _ComponentsRoundTextButton_H */
