...
#ifndef _ComponentsMenuButton_H
#define _ComponentsMenuButton_H
...
/* Forward declaration of the class Components::MenuButton */
#ifndef _ComponentsMenuButton_
  EW_DECLARE_CLASS( ComponentsMenuButton )
#define _ComponentsMenuButton_
#endif
...
/* Deklaration of class : 'Components::MenuButton' */
EW_DEFINE_FIELDS( ComponentsMenuButton, ComponentsIconTextButton )
  EW_OBJECT  ( HintText,        ViewsText )
  EW_PROPERTY( Hint,            XString )
EW_END_OF_FIELDS( ComponentsMenuButton )

/* Virtual Method Table (VMT) for the class : 'Components::MenuButton' */
EW_DEFINE_METHODS( ComponentsMenuButton, ComponentsIconTextButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsMenuButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsMenuButton _this, XSet aState )
  ...
  EW_METHOD( OnSetCaption,      void )( ComponentsIconTextButton _this, XString 
    value )
EW_END_OF_METHODS( ComponentsMenuButton )
