...
#ifndef _ComponentsNotificationButton_H
#define _ComponentsNotificationButton_H
...
/* Forward declaration of the class Components::NotificationButton */
#ifndef _ComponentsNotificationButton_
  EW_DECLARE_CLASS( ComponentsNotificationButton )
#define _ComponentsNotificationButton_
#endif
...
/* Deklaration of class : 'Components::NotificationButton' */
EW_DEFINE_FIELDS( ComponentsNotificationButton, ComponentsIconTextButton )
EW_END_OF_FIELDS( ComponentsNotificationButton )

/* Virtual Method Table (VMT) for the class : 'Components::NotificationButton' */
EW_DEFINE_METHODS( ComponentsNotificationButton, ComponentsIconTextButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsNotificationButton _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsIconTextButton _this, XSet aState )
  ...
  EW_METHOD( OnSetCaption,      void )( ComponentsIconTextButton _this, XString 
    value )
EW_END_OF_METHODS( ComponentsNotificationButton )
...
#endif /* _ComponentsNotificationButton_H */
