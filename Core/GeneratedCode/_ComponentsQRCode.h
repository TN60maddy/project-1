...
#ifndef _ComponentsQRCode_H
#define _ComponentsQRCode_H
...
/* Forward declaration of the class Components::QRCode */
#ifndef _ComponentsQRCode_
  EW_DECLARE_CLASS( ComponentsQRCode )
#define _ComponentsQRCode_
#endif
...
/* Deklaration of class : 'Components::QRCode' */
EW_DEFINE_FIELDS( ComponentsQRCode, QRCodeQRCode )
  EW_PROPERTY( Outlet,          XRef )
EW_END_OF_FIELDS( ComponentsQRCode )

/* Virtual Method Table (VMT) for the class : 'Components::QRCode' */
EW_DEFINE_METHODS( ComponentsQRCode, QRCodeQRCode )
  ...
  EW_METHOD( drawContent,       void )( QRCodeQRCode _this, GraphicsCanvas aCanvas, 
    XRect aClip, XPoint aOffset, XInt32 aOpacity, XBool aBlend )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( QRCodeQRCode _this, XPoint aSize )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsQRCode )
