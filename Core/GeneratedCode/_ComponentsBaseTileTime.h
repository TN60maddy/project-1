...
#ifndef _ComponentsBaseTileTime_H
#define _ComponentsBaseTileTime_H
...
/* Forward declaration of the class Components::BaseTileTime */
#ifndef _ComponentsBaseTileTime_
  EW_DECLARE_CLASS( ComponentsBaseTileTime )
#define _ComponentsBaseTileTime_
#endif
...
/* Deklaration of class : 'Components::BaseTileTime' */
EW_DEFINE_FIELDS( ComponentsBaseTileTime, ComponentsBaseTile )
EW_END_OF_FIELDS( ComponentsBaseTileTime )

/* Virtual Method Table (VMT) for the class : 'Components::BaseTileTime' */
EW_DEFINE_METHODS( ComponentsBaseTileTime, ComponentsBaseTile )
...
EW_END_OF_METHODS( ComponentsBaseTileTime )
...
#endif /* _ComponentsBaseTileTime_H */
