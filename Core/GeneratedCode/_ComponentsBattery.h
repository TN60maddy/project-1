...
#ifndef _ComponentsBattery_H
#define _ComponentsBattery_H
...
/* Forward declaration of the class Components::Battery */
#ifndef _ComponentsBattery_
  EW_DECLARE_CLASS( ComponentsBattery )
#define _ComponentsBattery_
#endif
...
/* Deklaration of class : 'Components::Battery' */
EW_DEFINE_FIELDS( ComponentsBattery, CoreGroup )
  EW_OBJECT  ( BatteryIcon,     ViewsImage )
  EW_OBJECT  ( LevelRectangle,  ViewsRectangle )
  EW_OBJECT  ( ChargingIcon,    ViewsImage )
  EW_PROPERTY( OutletLevel,     XRef )
  EW_PROPERTY( OutletStatus,    XRef )
  EW_PROPERTY( Color,           XColor )
  EW_PROPERTY( Level,           XInt32 )
  EW_PROPERTY( Status,          XInt32 )
  EW_PROPERTY( ScrollOffset,    XPoint )
EW_END_OF_FIELDS( ComponentsBattery )

/* Virtual Method Table (VMT) for the class : 'Components::Battery' */
EW_DEFINE_METHODS( ComponentsBattery, CoreGroup )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsBattery _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsBattery )
