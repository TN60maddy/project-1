...
#ifndef _ApplicationNotificationPopup_H
#define _ApplicationNotificationPopup_H
...
/* Forward declaration of the class Application::NotificationPopup */
#ifndef _ApplicationNotificationPopup_
  EW_DECLARE_CLASS( ApplicationNotificationPopup )
#define _ApplicationNotificationPopup_
#endif
...
/* Deklaration of class : 'Application::NotificationPopup' */
EW_DEFINE_FIELDS( ApplicationNotificationPopup, ApplicationPopup )
  ...
  EW_VARIABLE( type,            XEnum )
EW_END_OF_FIELDS( ApplicationNotificationPopup )

/* Virtual Method Table (VMT) for the class : 'Application::NotificationPopup' */
EW_DEFINE_METHODS( ApplicationNotificationPopup, ApplicationPopup )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationNotificationPopup _this, XSet 
    aState )
  ...
  EW_METHOD( OnSetNotificationId, void )( ApplicationNotificationPopup _this, XInt32 
    value )
EW_END_OF_METHODS( ApplicationNotificationPopup )
...
#endif /* _ApplicationNotificationPopup_H */
