...
#ifndef _ApplicationNumKeyboardPopup_H
#define _ApplicationNumKeyboardPopup_H
...
/* Forward declaration of the class Application::NumKeyboardPopup */
#ifndef _ApplicationNumKeyboardPopup_
  EW_DECLARE_CLASS( ApplicationNumKeyboardPopup )
#define _ApplicationNumKeyboardPopup_
#endif
...
/* Deklaration of class : 'Application::NumKeyboardPopup' */
EW_DEFINE_FIELDS( ApplicationNumKeyboardPopup, ApplicationInputPopup )
  EW_OBJECT  ( NumKeyboard,     ComponentsNumKeyboard )
EW_END_OF_FIELDS( ApplicationNumKeyboardPopup )

/* Virtual Method Table (VMT) for the class : 'Application::NumKeyboardPopup' */
EW_DEFINE_METHODS( ApplicationNumKeyboardPopup, ApplicationInputPopup )
  ...
  EW_METHOD( OnSetOutlet,       void )( ApplicationInputPopup _this, XRef value )
EW_END_OF_METHODS( ApplicationNumKeyboardPopup )

#ifdef __cplusplus
  }
#endif

#endif /* _ApplicationNumKeyboardPopup_H */
