...
#ifndef _ComponentsLogo_H
#define _ComponentsLogo_H
...
/* Forward declaration of the class Components::Logo */
#ifndef _ComponentsLogo_
  EW_DECLARE_CLASS( ComponentsLogo )
#define _ComponentsLogo_
#endif
...
/* Deklaration of class : 'Components::Logo' */
EW_DEFINE_FIELDS( ComponentsLogo, CoreGroup )
  EW_OBJECT  ( LogoTR,          ViewsImage )
  EW_OBJECT  ( LogoBR,          ViewsImage )
  EW_OBJECT  ( LogoBL,          ViewsImage )
  EW_OBJECT  ( RectangleT,      ViewsRectangle )
  EW_OBJECT  ( RectangleM,      ViewsRectangle )
  EW_OBJECT  ( RectangleB,      ViewsRectangle )
  EW_OBJECT  ( Circle,          ViewsRectangle )
EW_END_OF_FIELDS( ComponentsLogo )

/* Virtual Method Table (VMT) for the class : 'Components::Logo' */
EW_DEFINE_METHODS( ComponentsLogo, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsLogo )

#ifdef __cplusplus
  }
#endif

#endif /* _ComponentsLogo_H */
