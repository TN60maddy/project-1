...
#ifndef _ApplicationBoot_H
#define _ApplicationBoot_H
...
/* Forward declaration of the class Application::Boot */
#ifndef _ApplicationBoot_
  EW_DECLARE_CLASS( ApplicationBoot )
#define _ApplicationBoot_
#endif
...
/* Deklaration of class : 'Application::Boot' */
EW_DEFINE_FIELDS( ApplicationBoot, NavigationPage )
  EW_OBJECT  ( Timer,           CoreTimer )
  EW_OBJECT  ( LogoImage,       ComponentsLogo )
  EW_OBJECT  ( ProgressBar,     ComponentsProgressBar )
EW_END_OF_FIELDS( ApplicationBoot )

/* Virtual Method Table (VMT) for the class : 'Application::Boot' */
EW_DEFINE_METHODS( ApplicationBoot, NavigationPage )
...
EW_END_OF_METHODS( ApplicationBoot )
