...
#ifndef _ApplicationMaintenanceAndCalibration_H
#define _ApplicationMaintenanceAndCalibration_H
...
/* Forward declaration of the class Application::MaintenanceAndCalibration */
#ifndef _ApplicationMaintenanceAndCalibration_
  EW_DECLARE_CLASS( ApplicationMaintenanceAndCalibration )
#define _ApplicationMaintenanceAndCalibration_
#endif
...
/* Deklaration of class : 'Application::MaintenanceAndCalibration' */
EW_DEFINE_FIELDS( ApplicationMaintenanceAndCalibration, ApplicationSettingsSubPage )
EW_END_OF_FIELDS( ApplicationMaintenanceAndCalibration )

/* Virtual Method Table (VMT) for the class : 'Application::MaintenanceAndCalibration' */
EW_DEFINE_METHODS( ApplicationMaintenanceAndCalibration, ApplicationSettingsSubPage )
  ...
  EW_METHOD( onBack,            void )( ApplicationSettingsSubPage _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationMaintenanceAndCalibration )

#ifdef __cplusplus
  }
#endif

#endif /* _ApplicationMaintenanceAndCalibration_H */
