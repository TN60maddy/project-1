...
#ifndef _ApplicationBolusRateSettings_H
#define _ApplicationBolusRateSettings_H
...
/* Forward declaration of the class Application::BolusRateSettings */
#ifndef _ApplicationBolusRateSettings_
  EW_DECLARE_CLASS( ApplicationBolusRateSettings )
#define _ApplicationBolusRateSettings_
#endif
...
/* Deklaration of class : 'Application::BolusRateSettings' */
EW_DEFINE_FIELDS( ApplicationBolusRateSettings, ApplicationSettingsPage )
  EW_OBJECT  ( InfoTip,         ComponentsInfoTip )
  EW_OBJECT  ( ValueDisplay,    ComponentsIntValueDisplay )
  EW_OBJECT  ( UnitText,        ViewsText )
EW_END_OF_FIELDS( ApplicationBolusRateSettings )

/* Virtual Method Table (VMT) for the class : 'Application::BolusRateSettings' */
EW_DEFINE_METHODS( ApplicationBolusRateSettings, ApplicationSettingsPage )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationBolusRateSettings _this, XSet 
    aState )
...
EW_END_OF_METHODS( ApplicationBolusRateSettings )
...
#endif /* _ApplicationBolusRateSettings_H */
