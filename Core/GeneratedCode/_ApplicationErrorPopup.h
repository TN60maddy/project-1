...
#ifndef _ApplicationErrorPopup_H
#define _ApplicationErrorPopup_H
...
/* Forward declaration of the class Application::ErrorPopup */
#ifndef _ApplicationErrorPopup_
  EW_DECLARE_CLASS( ApplicationErrorPopup )
#define _ApplicationErrorPopup_
#endif
...
/* Deklaration of class : 'Application::ErrorPopup' */
EW_DEFINE_FIELDS( ApplicationErrorPopup, ApplicationNotificationPopup )
  EW_OBJECT  ( ErrorCodeText,   ViewsText )
  EW_OBJECT  ( MuteButton,      ComponentsNotificationButton )
EW_END_OF_FIELDS( ApplicationErrorPopup )

/* Virtual Method Table (VMT) for the class : 'Application::ErrorPopup' */
EW_DEFINE_METHODS( ApplicationErrorPopup, ApplicationNotificationPopup )
  ...
  EW_METHOD( OnSetNotificationId, void )( ApplicationErrorPopup _this, XInt32 value )
EW_END_OF_METHODS( ApplicationErrorPopup )
...
#endif /* _ApplicationErrorPopup_H */
