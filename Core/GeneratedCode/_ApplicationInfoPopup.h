...
#ifndef _ApplicationInfoPopup_H
#define _ApplicationInfoPopup_H
...
/* Forward declaration of the class Application::InfoPopup */
#ifndef _ApplicationInfoPopup_
  EW_DECLARE_CLASS( ApplicationInfoPopup )
#define _ApplicationInfoPopup_
#endif
...
/* Deklaration of class : 'Application::InfoPopup' */
EW_DEFINE_FIELDS( ApplicationInfoPopup, ApplicationNotificationPopup )
  EW_OBJECT  ( OKButton,        ComponentsNotificationButton )
EW_END_OF_FIELDS( ApplicationInfoPopup )

/* Virtual Method Table (VMT) for the class : 'Application::InfoPopup' */
EW_DEFINE_METHODS( ApplicationInfoPopup, ApplicationNotificationPopup )
  ...
  EW_METHOD( OnSetNotificationId, void )( ApplicationNotificationPopup _this, XInt32 
    value )
EW_END_OF_METHODS( ApplicationInfoPopup )
