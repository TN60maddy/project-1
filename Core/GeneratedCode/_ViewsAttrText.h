...
/* The class Views::AttrText provides a kind of view specialized to print text enriched 
   ...
   - {para[#l,#r,#t,#b][:#c]} - The same as above but the left/right alignment is 
   determined depending on writing direction of the first strong character found 
   in the paragraph. If the paragraph starts with a right-to-left character and 
   the property @EnableBidi is 'true', the right alignment is selected. Otherwise 
   the left alignment is selected.
   - {parlj[#l,#r,#t,#b][:#c]} - The same as above but the text is left aligned 
   and justified.
   - {parrj[#l,#r,#t,#b][:#c]} - The same as above but the text is right aligned 
   and justified.
   - {parcj[#l,#r,#t,#b][:#c]} - The same as above but the text is centered and 
   justified.
   - {paraj[#l,#r,#t,#b][:#c]} - The same as above but the left/right alignment 
   is determined depending on writing direction of the first strong character found 
   in the paragraph. If the paragraph starts with a right-to-left character and 
   the property @EnableBidi is 'true', the right alignment is selected. Otherwise 
   the left alignment is selected.
   ...
   can be set, so the text can be shown with fancy opacity gradients.
   ...
   string @String as containing bi-directional text. In such case, all enclosed 
   paragraph contents are processed by the Unicode Bidirectional Algorithm. If the 
   paragraphs contain Arabic characters, the algorithm performs the shaping and 
   determines the obligatory Arabic ligatures.
