...
#ifndef _NavigationPage_H
#define _NavigationPage_H
...
/* Page View. */
EW_DEFINE_FIELDS( NavigationPage, CoreGroup )
  EW_PROPERTY( Caption,         XString )
EW_END_OF_FIELDS( NavigationPage )

/* Virtual Method Table (VMT) for the class : 'Navigation::Page' */
EW_DEFINE_METHODS( NavigationPage, CoreGroup )
...
EW_END_OF_METHODS( NavigationPage )
