...
#ifndef _ApplicationSettingsSubPage_H
#define _ApplicationSettingsSubPage_H
...
/* Forward declaration of the class Application::SettingsSubPage */
#ifndef _ApplicationSettingsSubPage_
  EW_DECLARE_CLASS( ApplicationSettingsSubPage )
#define _ApplicationSettingsSubPage_
#endif
...
/* Deklaration of class : 'Application::SettingsSubPage' */
EW_DEFINE_FIELDS( ApplicationSettingsSubPage, ApplicationSettingsPage )
  EW_OBJECT  ( DontTouchBehind, CoreSimpleTouchHandler )
EW_END_OF_FIELDS( ApplicationSettingsSubPage )

/* Virtual Method Table (VMT) for the class : 'Application::SettingsSubPage' */
EW_DEFINE_METHODS( ApplicationSettingsSubPage, ApplicationSettingsPage )
  ...
  EW_METHOD( onBack,            void )( ApplicationSettingsSubPage _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationSettingsSubPage )
...
#endif /* _ApplicationSettingsSubPage_H */
