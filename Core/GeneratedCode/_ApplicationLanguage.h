...
#ifndef _ApplicationLanguage_H
#define _ApplicationLanguage_H
...
/* Forward declaration of the class Application::Language */
#ifndef _ApplicationLanguage_
  EW_DECLARE_CLASS( ApplicationLanguage )
#define _ApplicationLanguage_
#endif
...
/* Deklaration of class : 'Application::Language' */
EW_DEFINE_FIELDS( ApplicationLanguage, ApplicationSettingsSubPage )
EW_END_OF_FIELDS( ApplicationLanguage )

/* Virtual Method Table (VMT) for the class : 'Application::Language' */
EW_DEFINE_METHODS( ApplicationLanguage, ApplicationSettingsSubPage )
  ...
  EW_METHOD( onBack,            void )( ApplicationSettingsSubPage _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationLanguage )

#ifdef __cplusplus
  }
#endif

#endif /* _ApplicationLanguage_H */
