...
#ifndef _ComponentsGaugeExt_H
#define _ComponentsGaugeExt_H
...
/* Forward declaration of the class Components::GaugeExt */
#ifndef _ComponentsGaugeExt_
  EW_DECLARE_CLASS( ComponentsGaugeExt )
#define _ComponentsGaugeExt_
#endif
...
/* Deklaration of class : 'Components::GaugeExt' */
EW_DEFINE_FIELDS( ComponentsGaugeExt, ComponentsGaugeBase )
  EW_PROPERTY( NormalRangeMax,  XInt32 )
  EW_PROPERTY( WarningRangeMax, XInt32 )
  EW_PROPERTY( ErrorRangeMax,   XInt32 )
EW_END_OF_FIELDS( ComponentsGaugeExt )

/* Virtual Method Table (VMT) for the class : 'Components::GaugeExt' */
EW_DEFINE_METHODS( ComponentsGaugeExt, ComponentsGaugeBase )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsGaugeExt _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( getNeedlePos,      XPoint )( ComponentsGaugeExt _this )
EW_END_OF_METHODS( ComponentsGaugeExt )
