...
#ifndef _NavigationContainer_H
#define _NavigationContainer_H
...
EW_DEFINE_FIELDS( NavigationContainer, CoreGroup )
  EW_OBJECT  ( DontTouchBehind, CoreSimpleTouchHandler )
  EW_PROPERTY( IsModal,         XBool )
EW_END_OF_FIELDS( NavigationContainer )

/* Virtual Method Table (VMT) for the class : 'Navigation::Container' */
EW_DEFINE_METHODS( NavigationContainer, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( NavigationContainer )
