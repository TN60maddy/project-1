...
#ifndef _ApplicationWifiSettings_H
#define _ApplicationWifiSettings_H
...
/* Forward declaration of the class Application::WifiSettings */
#ifndef _ApplicationWifiSettings_
  EW_DECLARE_CLASS( ApplicationWifiSettings )
#define _ApplicationWifiSettings_
#endif
...
/* Deklaration of class : 'Application::WifiSettings' */
EW_DEFINE_FIELDS( ApplicationWifiSettings, ApplicationSettingsSubPage )
  EW_OBJECT  ( ToggleButton,    ComponentsToggleButton )
  EW_OBJECT  ( WiFiText,        ViewsText )
  EW_OBJECT  ( ScanCodeText,    ViewsText )
  EW_OBJECT  ( QRCodeBg,        ViewsRectangle )
  EW_OBJECT  ( QRCode,          ComponentsQRCode )
  EW_OBJECT  ( NetworksText,    ViewsText )
  EW_OBJECT  ( NetworkList,     ComponentsDataList )
EW_END_OF_FIELDS( ApplicationWifiSettings )

/* Virtual Method Table (VMT) for the class : 'Application::WifiSettings' */
EW_DEFINE_METHODS( ApplicationWifiSettings, ApplicationSettingsSubPage )
  ...
  EW_METHOD( onBack,            void )( ApplicationSettingsSubPage _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationWifiSettings )
...
#endif /* _ApplicationWifiSettings_H */
