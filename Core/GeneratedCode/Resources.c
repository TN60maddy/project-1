...
EW_CONST_STRING_PRAGMA static const unsigned int _StringsDefault0[] =
{
  ...
  0x54001140, 0xA5839B95, 0x0004C6B9, 0x02E00059, 0x182C4248, 0xAA0E4693, 0x9E5153E5,
  0x8897B439, 0x90E83935, 0xE469345F, 0x01104310, 0x3D8ED0A9, 0x8797E479, 0xE0E001CC,
  0x15164D1D, 0xE2529093, 0x0C8F93C7, 0x891744FA, 0x99242925, 0xA965274F, 0x3E3D8523,
  0x01481208, 0x00000001, 0x00000000
};

/* Constant values used in this 'C' module only. */
static const XPoint _Const0000 = { 0, 0 };
static const XStringRes _Const0001 = { _StringsDefault0, 0x0133 };
static const XStringRes _Const0002 = { _StringsDefault0, 0x015C };
...
XInt32 ResourcesFont_GetGlyphAdvance( ResourcesFont _this, XChar aCharCode )
{
  ...
  handle = _this->font;
  {
    unsigned int  glyphId = EwGetGlyphId((XFont*)handle, aCharCode );
    XGlyphMetrics metrics;

    if ( glyphId && EwGetGlyphMetrics((XFont*)handle, glyphId, &metrics ))
