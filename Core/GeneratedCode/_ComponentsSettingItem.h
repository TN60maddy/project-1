...
#ifndef _ComponentsSettingItem_H
#define _ComponentsSettingItem_H
...
/* Forward declaration of the class Components::SettingItem */
#ifndef _ComponentsSettingItem_
  EW_DECLARE_CLASS( ComponentsSettingItem )
#define _ComponentsSettingItem_
#endif
...
/* Deklaration of class : 'Components::SettingItem' */
EW_DEFINE_FIELDS( ComponentsSettingItem, CoreGroup )
  EW_OBJECT  ( CaptionText,     ViewsText )
  EW_OBJECT  ( ValueBg,         ViewsRectangle )
  EW_PROPERTY( Caption,         XString )
  EW_PROPERTY( ValueAreaWith,   XInt32 )
  EW_PROPERTY( ValuePadding,    XInt32 )
  EW_PROPERTY( CaptionValueSpace, XInt32 )
EW_END_OF_FIELDS( ComponentsSettingItem )

/* Virtual Method Table (VMT) for the class : 'Components::SettingItem' */
EW_DEFINE_METHODS( ComponentsSettingItem, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsSettingItem _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsSettingItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsSettingItem )
...
#endif /* _ComponentsSettingItem_H */
