...
#ifndef _ComponentsRoundButton_H
#define _ComponentsRoundButton_H
...
/* Forward declaration of the class Components::RoundButton */
#ifndef _ComponentsRoundButton_
  EW_DECLARE_CLASS( ComponentsRoundButton )
#define _ComponentsRoundButton_
#endif
...
/* Deklaration of class : 'Components::RoundButton' */
EW_DEFINE_FIELDS( ComponentsRoundButton, ComponentsBaseButton )
EW_END_OF_FIELDS( ComponentsRoundButton )

/* Virtual Method Table (VMT) for the class : 'Components::RoundButton' */
EW_DEFINE_METHODS( ComponentsRoundButton, ComponentsBaseButton )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsBaseButton _this, XSet aState )
...
EW_END_OF_METHODS( ComponentsRoundButton )
...
#endif /* _ComponentsRoundButton_H */
