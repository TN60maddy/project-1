...
#ifndef _ApplicationConfirmationPopup_H
#define _ApplicationConfirmationPopup_H
...
/* Forward declaration of the class Application::ConfirmationPopup */
#ifndef _ApplicationConfirmationPopup_
  EW_DECLARE_CLASS( ApplicationConfirmationPopup )
#define _ApplicationConfirmationPopup_
#endif
...
/* Deklaration of class : 'Application::ConfirmationPopup' */
EW_DEFINE_FIELDS( ApplicationConfirmationPopup, ApplicationMessagePopup )
  EW_OBJECT  ( ConfirmButton,   ComponentsTextButton )
  EW_OBJECT  ( CancelButton,    ComponentsTextButton )
  EW_PROPERTY( OnConfirm,       XSlot )
  EW_PROPERTY( OnCancel,        XSlot )
EW_END_OF_FIELDS( ApplicationConfirmationPopup )

/* Virtual Method Table (VMT) for the class : 'Application::ConfirmationPopup' */
EW_DEFINE_METHODS( ApplicationConfirmationPopup, ApplicationMessagePopup )
...
EW_END_OF_METHODS( ApplicationConfirmationPopup )
...
#endif /* _ApplicationConfirmationPopup_H */
