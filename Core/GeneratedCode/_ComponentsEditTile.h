...
#ifndef _ComponentsEditTile_H
#define _ComponentsEditTile_H
...
/* Deklaration of class : 'Components::EditTile' */
EW_DEFINE_FIELDS( ComponentsEditTile, ComponentsTile )
  EW_VARIABLE( ViewTile,        ComponentsTile )
EW_END_OF_FIELDS( ComponentsEditTile )

/* Virtual Method Table (VMT) for the class : 'Components::EditTile' */
EW_DEFINE_METHODS( ComponentsEditTile, ComponentsTile )
...
EW_END_OF_METHODS( ComponentsEditTile )
