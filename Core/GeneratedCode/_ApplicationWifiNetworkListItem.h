...
#ifndef _ApplicationWifiNetworkListItem_H
#define _ApplicationWifiNetworkListItem_H
...
/* Forward declaration of the class Application::WifiNetworkListItem */
#ifndef _ApplicationWifiNetworkListItem_
  EW_DECLARE_CLASS( ApplicationWifiNetworkListItem )
#define _ApplicationWifiNetworkListItem_
#endif
...
/* Deklaration of class : 'Application::WifiNetworkListItem' */
EW_DEFINE_FIELDS( ApplicationWifiNetworkListItem, ComponentsListItem )
  EW_OBJECT  ( SSIDText,        ViewsText )
  EW_OBJECT  ( ConnectedIcon,   ViewsImage )
  EW_OBJECT  ( WifiIcon,        ViewsImage )
  EW_OBJECT  ( InfoIcon,        ViewsImage )
  EW_OBJECT  ( TouchHandler,    CoreSimpleTouchHandler )
EW_END_OF_FIELDS( ApplicationWifiNetworkListItem )

/* Virtual Method Table (VMT) for the class : 'Application::WifiNetworkListItem' */
EW_DEFINE_METHODS( ApplicationWifiNetworkListItem, ComponentsListItem )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationWifiNetworkListItem _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( UpdateData,        void )( ApplicationWifiNetworkListItem _this, XInt32 
    aItemIndex )
EW_END_OF_METHODS( ApplicationWifiNetworkListItem )
...
#endif /* _ApplicationWifiNetworkListItem_H */
