...
#ifndef _ApplicationInfusionStopPopup_H
#define _ApplicationInfusionStopPopup_H
...
/* Forward declaration of the class Application::InfusionStopPopup */
#ifndef _ApplicationInfusionStopPopup_
  EW_DECLARE_CLASS( ApplicationInfusionStopPopup )
#define _ApplicationInfusionStopPopup_
#endif
...
/* Deklaration of class : 'Application::InfusionStopPopup' */
EW_DEFINE_FIELDS( ApplicationInfusionStopPopup, ApplicationBaseMenuPopup )
  EW_OBJECT  ( RestartButton,   ComponentsTextButton )
  EW_OBJECT  ( ClearSettingsButton, ComponentsTextButton )
EW_END_OF_FIELDS( ApplicationInfusionStopPopup )

/* Virtual Method Table (VMT) for the class : 'Application::InfusionStopPopup' */
EW_DEFINE_METHODS( ApplicationInfusionStopPopup, ApplicationBaseMenuPopup )
  ...
  EW_METHOD( onClose,           void )( ApplicationInfusionStopPopup _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationInfusionStopPopup )
...
#endif /* _ApplicationInfusionStopPopup_H */
