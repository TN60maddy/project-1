...
#ifndef _ApplicationGeneralSettings_H
#define _ApplicationGeneralSettings_H
...
/* Forward declaration of the class Application::GeneralSettings */
#ifndef _ApplicationGeneralSettings_
  EW_DECLARE_CLASS( ApplicationGeneralSettings )
#define _ApplicationGeneralSettings_
#endif
...
/* Deklaration of class : 'Application::GeneralSettings' */
EW_DEFINE_FIELDS( ApplicationGeneralSettings, ApplicationSettingsPage )
  ...
  EW_OBJECT  ( WifiButton,      ComponentsSettingsOpenButton )
  EW_OBJECT  ( AudioVolumeControlButton, ComponentsSettingsOpenButton )
  EW_OBJECT  ( DateAndTimeButton, ComponentsSettingsOpenButton )
  EW_OBJECT  ( LanguageButton,  ComponentsSettingsOpenButton )
  EW_OBJECT  ( SoftwareUpdateButton, ComponentsSettingsOpenButton )
  EW_OBJECT  ( AboutButton,     ComponentsSettingsOpenButton )
  EW_OBJECT  ( MaintenaceAndCalibrationButton, ComponentsSettingsOpenButton )
EW_END_OF_FIELDS( ApplicationGeneralSettings )

/* Virtual Method Table (VMT) for the class : 'Application::GeneralSettings' */
EW_DEFINE_METHODS( ApplicationGeneralSettings, ApplicationSettingsPage )
...
EW_END_OF_METHODS( ApplicationGeneralSettings )
...
#endif /* _ApplicationGeneralSettings_H */
