...
#ifndef _ComponentsInfoTip_H
#define _ComponentsInfoTip_H
...
/* Forward declaration of the class Components::InfoTip */
#ifndef _ComponentsInfoTip_
  EW_DECLARE_CLASS( ComponentsInfoTip )
#define _ComponentsInfoTip_
#endif
...
/* Deklaration of class : 'Components::InfoTip' */
EW_DEFINE_FIELDS( ComponentsInfoTip, CoreGroup )
  EW_OBJECT  ( TipText,         ViewsText )
  EW_OBJECT  ( IconImage,       ViewsImage )
  EW_OBJECT  ( SimpleTouchHandler, CoreSimpleTouchHandler )
  EW_PROPERTY( TipString,       XString )
  EW_PROPERTY( InfoCaption,     XString )
  EW_PROPERTY( InfoMessage,     XString )
EW_END_OF_FIELDS( ComponentsInfoTip )

/* Virtual Method Table (VMT) for the class : 'Components::InfoTip' */
EW_DEFINE_METHODS( ComponentsInfoTip, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsInfoTip _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsInfoTip _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsInfoTip )
