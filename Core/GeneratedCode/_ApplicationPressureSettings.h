...
#ifndef _ApplicationPressureSettings_H
#define _ApplicationPressureSettings_H
...
/* Forward declaration of the class Application::PressureSettings */
#ifndef _ApplicationPressureSettings_
  EW_DECLARE_CLASS( ApplicationPressureSettings )
#define _ApplicationPressureSettings_
#endif
...
/* Deklaration of class : 'Application::PressureSettings' */
EW_DEFINE_FIELDS( ApplicationPressureSettings, ApplicationSettingsPage )
...
EW_END_OF_FIELDS( ApplicationPressureSettings )

/* Virtual Method Table (VMT) for the class : 'Application::PressureSettings' */
EW_DEFINE_METHODS( ApplicationPressureSettings, ApplicationSettingsPage )
...
EW_END_OF_METHODS( ApplicationPressureSettings )
...
#endif /* _ApplicationPressureSettings_H */
