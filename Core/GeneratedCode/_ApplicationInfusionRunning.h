...
#ifndef _ApplicationInfusionRunning_H
#define _ApplicationInfusionRunning_H
...
/* Forward declaration of the class Application::InfusionRunning */
#ifndef _ApplicationInfusionRunning_
  EW_DECLARE_CLASS( ApplicationInfusionRunning )
#define _ApplicationInfusionRunning_
#endif
...
/* Deklaration of class : 'Application::InfusionRunning' */
EW_DEFINE_FIELDS( ApplicationInfusionRunning, ApplicationInfusionBasePage )
  EW_OBJECT  ( StopButton,      ComponentsTextButton )
  EW_OBJECT  ( TileFlowRate,    ComponentsTile )
  EW_OBJECT  ( RemainingVolumeTile, ComponentsTileInRunning )
  EW_OBJECT  ( RemainingTimeTile, ComponentsTileTimeInRunning )
  EW_OBJECT  ( PressureTile,    ComponentsPressureTile )
  EW_OBJECT  ( BolusRateButton, ComponentsSettingsButton )
  EW_OBJECT  ( StopEventHandler, CoreSystemEventHandler )
EW_END_OF_FIELDS( ApplicationInfusionRunning )

/* Virtual Method Table (VMT) for the class : 'Application::InfusionRunning' */
EW_DEFINE_METHODS( ApplicationInfusionRunning, ApplicationInfusionBasePage )
  ...
  EW_METHOD( OnSetopacity,      void )( ApplicationInfusionRunning _this, XInt32 
    value )
EW_END_OF_METHODS( ApplicationInfusionRunning )
...
#endif /* _ApplicationInfusionRunning_H */
