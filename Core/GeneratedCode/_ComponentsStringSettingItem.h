...
#ifndef _ComponentsStringSettingItem_H
#define _ComponentsStringSettingItem_H
...
/* Forward declaration of the class Components::StringSettingItem */
#ifndef _ComponentsStringSettingItem_
  EW_DECLARE_CLASS( ComponentsStringSettingItem )
#define _ComponentsStringSettingItem_
#endif
...
/* Deklaration of class : 'Components::StringSettingItem' */
EW_DEFINE_FIELDS( ComponentsStringSettingItem, ComponentsSettingItem )
  EW_OBJECT  ( ValueDisplay,    ComponentsStringValueDisplay )
  EW_PROPERTY( Outlet,          XRef )
  EW_PROPERTY( Value,           XString )
EW_END_OF_FIELDS( ComponentsStringSettingItem )

/* Virtual Method Table (VMT) for the class : 'Components::StringSettingItem' */
EW_DEFINE_METHODS( ComponentsStringSettingItem, ComponentsSettingItem )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsStringSettingItem _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsStringSettingItem _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsStringSettingItem )
...
#endif /* _ComponentsStringSettingItem_H */
