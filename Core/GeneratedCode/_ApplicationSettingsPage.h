...
#ifndef _ApplicationSettingsPage_H
#define _ApplicationSettingsPage_H
...
/* Forward declaration of the class Application::SettingsPage */
#ifndef _ApplicationSettingsPage_
  EW_DECLARE_CLASS( ApplicationSettingsPage )
#define _ApplicationSettingsPage_
#endif
...
/* Deklaration of class : 'Application::SettingsPage' */
EW_DEFINE_FIELDS( ApplicationSettingsPage, NavigationPage )
  EW_OBJECT  ( Scrim,           ViewsRectangle )
  EW_OBJECT  ( ContentBackground, ViewsRectangle )
  EW_OBJECT  ( CaptionText,     ViewsText )
  EW_OBJECT  ( BackButton,      ComponentsTextButton )
EW_END_OF_FIELDS( ApplicationSettingsPage )

/* Virtual Method Table (VMT) for the class : 'Application::SettingsPage' */
EW_DEFINE_METHODS( ApplicationSettingsPage, NavigationPage )
...
EW_END_OF_METHODS( ApplicationSettingsPage )
...
#endif /* _ApplicationSettingsPage_H */
