...
#ifndef _ComponentsSpecialKeyButton_H
#define _ComponentsSpecialKeyButton_H
...
/* Forward declaration of the class Components::SpecialKeyButton */
#ifndef _ComponentsSpecialKeyButton_
  EW_DECLARE_CLASS( ComponentsSpecialKeyButton )
#define _ComponentsSpecialKeyButton_
#endif
...
/* Deklaration of class : 'Components::SpecialKeyButton' */
EW_DEFINE_FIELDS( ComponentsSpecialKeyButton, ComponentsKeyButton )
  EW_OBJECT  ( Image,           ViewsImage )
  EW_PROPERTY( Icon,            ResourcesBitmap )
EW_END_OF_FIELDS( ComponentsSpecialKeyButton )

/* Virtual Method Table (VMT) for the class : 'Components::SpecialKeyButton' */
EW_DEFINE_METHODS( ComponentsSpecialKeyButton, ComponentsKeyButton )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsSpecialKeyButton _this, XSet aState )
...
EW_END_OF_METHODS( ComponentsSpecialKeyButton )
...
#endif /* _ComponentsSpecialKeyButton_H */
