...
#ifndef _ApplicationStartInfusionConfirmPopup_H
#define _ApplicationStartInfusionConfirmPopup_H
...
/* Forward declaration of the class Application::StartInfusionConfirmPopup */
#ifndef _ApplicationStartInfusionConfirmPopup_
  EW_DECLARE_CLASS( ApplicationStartInfusionConfirmPopup )
#define _ApplicationStartInfusionConfirmPopup_
#endif
...
/* Deklaration of class : 'Application::StartInfusionConfirmPopup' */
EW_DEFINE_FIELDS( ApplicationStartInfusionConfirmPopup, ApplicationConfirmationPopup )
  EW_OBJECT  ( FlowRateTile,    ComponentsBaseTile )
  EW_OBJECT  ( InfusionVolumeTile, ComponentsBaseTile )
  EW_OBJECT  ( BaseTileTime,    ComponentsBaseTileTime )
EW_END_OF_FIELDS( ApplicationStartInfusionConfirmPopup )

/* Virtual Method Table (VMT) for the class : 'Application::StartInfusionConfirmPopup' */
EW_DEFINE_METHODS( ApplicationStartInfusionConfirmPopup, ApplicationConfirmationPopup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( OnSetCaption,      void )( ApplicationMessagePopup _this, XString value )
  EW_METHOD( onClose,           void )( NavigationPage _this, XObject sender )
EW_END_OF_METHODS( ApplicationStartInfusionConfirmPopup )

#ifdef __cplusplus
  }
#endif

#endif /* _ApplicationStartInfusionConfirmPopup_H */
