...
/* Deklaration of class : 'Components::TextButton' */
EW_DEFINE_FIELDS( ComponentsTextButton, ComponentsBaseButton )
  EW_OBJECT  ( CaptionText,     ViewsText )
  EW_PROPERTY( Font,            ResourcesFont )
  EW_PROPERTY( Caption,         XString )
  EW_PROPERTY( CaptionColor,    XColor )
  EW_PROPERTY( CaptionColorDisabled, XColor )
EW_END_OF_FIELDS( ComponentsTextButton )

/* Virtual Method Table (VMT) for the class : 'Components::TextButton' */
EW_DEFINE_METHODS( ComponentsTextButton, ComponentsBaseButton )
  ...
  EW_METHOD( OnSetCaption,      void )( ComponentsTextButton _this, XString value )
