...
#ifndef _ApplicationHome_H
#define _ApplicationHome_H
...
/* Forward declaration of the class Application::Home */
#ifndef _ApplicationHome_
  EW_DECLARE_CLASS( ApplicationHome )
#define _ApplicationHome_
#endif
...
/* Deklaration of class : 'Application::Home' */
EW_DEFINE_FIELDS( ApplicationHome, ApplicationInfusionBasePage )
  EW_OBJECT  ( TileFlowRate,    ComponentsTile )
  EW_OBJECT  ( TileVolume,      ComponentsTile )
  EW_OBJECT  ( TileTime,        ComponentsTileTime )
  EW_OBJECT  ( StartButton,     ComponentsTextButton )
EW_END_OF_FIELDS( ApplicationHome )

/* Virtual Method Table (VMT) for the class : 'Application::Home' */
EW_DEFINE_METHODS( ApplicationHome, ApplicationInfusionBasePage )
  ...
  EW_METHOD( OnSetopacity,      void )( ApplicationHome _this, XInt32 value )
EW_END_OF_METHODS( ApplicationHome )
