...
#ifndef _ComponentsDataList_H
#define _ComponentsDataList_H
...
/* Forward declaration of the class Components::DataList */
#ifndef _ComponentsDataList_
  EW_DECLARE_CLASS( ComponentsDataList )
#define _ComponentsDataList_
#endif
...
/* Deklaration of class : 'Components::DataList' */
EW_DEFINE_FIELDS( ComponentsDataList, CoreGroup )
  EW_OBJECT  ( SlideTouchHandler, CoreSlideTouchHandler )
  EW_OBJECT  ( List,            CoreVerticalList )
  EW_OBJECT  ( Scrollbar,       ComponentsVertScrollbar )
  EW_OBJECT  ( FadeTop,         ViewsRectangle )
  EW_OBJECT  ( FadeBottom,      ViewsRectangle )
  EW_PROPERTY( DataProvider,    DeviceDataProvider )
  EW_VARIABLE( View,            CoreView )
  EW_PROPERTY( ItemClass,       XClass )
  EW_PROPERTY( ItemHeight,      XInt32 )
  EW_VARIABLE( Item,            XInt32 )
EW_END_OF_FIELDS( ComponentsDataList )

/* Virtual Method Table (VMT) for the class : 'Components::DataList' */
EW_DEFINE_METHODS( ComponentsDataList, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsDataList _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsDataList _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsDataList )
...
/* The following define announces the presence of the method Components::DataList.OnSetDataProvider(). */
#define _ComponentsDataList__OnSetDataProvider_
