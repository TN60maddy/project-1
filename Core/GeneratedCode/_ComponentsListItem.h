...
#ifndef _ComponentsListItem_H
#define _ComponentsListItem_H
...
/* Forward declaration of the class Components::ListItem */
#ifndef _ComponentsListItem_
  EW_DECLARE_CLASS( ComponentsListItem )
#define _ComponentsListItem_
#endif
...
/* Deklaration of class : 'Components::ListItem' */
EW_DEFINE_FIELDS( ComponentsListItem, CoreGroup )
  EW_PROPERTY( DataProvider,    DeviceDataProvider )
  EW_VARIABLE( Index,           XInt32 )
EW_END_OF_FIELDS( ComponentsListItem )

/* Virtual Method Table (VMT) for the class : 'Components::ListItem' */
EW_DEFINE_METHODS( ComponentsListItem, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( UpdateData,        void )( ComponentsListItem _this, XInt32 aItemIndex )
EW_END_OF_METHODS( ComponentsListItem )
