...
#ifndef _ComponentsGauge_H
#define _ComponentsGauge_H
...
/* Forward declaration of the class Components::Gauge */
#ifndef _ComponentsGauge_
  EW_DECLARE_CLASS( ComponentsGauge )
#define _ComponentsGauge_
#endif
...
EW_DEFINE_FIELDS( ComponentsGauge, ComponentsGaugeBase )
EW_END_OF_FIELDS( ComponentsGauge )

/* Virtual Method Table (VMT) for the class : 'Components::Gauge' */
EW_DEFINE_METHODS( ComponentsGauge, ComponentsGaugeBase )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsGauge _this, XSet aState )
...
EW_END_OF_METHODS( ComponentsGauge )
