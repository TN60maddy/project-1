...
#ifndef _ApplicationSoftwareUpdate_H
#define _ApplicationSoftwareUpdate_H
...
/* Forward declaration of the class Application::SoftwareUpdate */
#ifndef _ApplicationSoftwareUpdate_
  EW_DECLARE_CLASS( ApplicationSoftwareUpdate )
#define _ApplicationSoftwareUpdate_
#endif
...
/* Deklaration of class : 'Application::SoftwareUpdate' */
EW_DEFINE_FIELDS( ApplicationSoftwareUpdate, ApplicationSettingsSubPage )
  EW_OBJECT  ( StartUpdateButton, ComponentsTextButton )
  EW_OBJECT  ( IconImage,       ViewsImage )
  EW_OBJECT  ( VersionText,     ComponentsStringValueDisplay )
  EW_OBJECT  ( VersionDescText, ComponentsStringValueDisplay )
  EW_OBJECT  ( InfoText,        ViewsText )
EW_END_OF_FIELDS( ApplicationSoftwareUpdate )

/* Virtual Method Table (VMT) for the class : 'Application::SoftwareUpdate' */
EW_DEFINE_METHODS( ApplicationSoftwareUpdate, ApplicationSettingsSubPage )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationSoftwareUpdate _this, XSet aState )
  ...
  EW_METHOD( onBack,            void )( ApplicationSettingsSubPage _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationSoftwareUpdate )
...
#endif /* _ApplicationSoftwareUpdate_H */
