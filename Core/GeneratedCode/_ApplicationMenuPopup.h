...
#ifndef _ApplicationMenuPopup_H
#define _ApplicationMenuPopup_H
...
/* Forward declaration of the class Application::MenuPopup */
#ifndef _ApplicationMenuPopup_
  EW_DECLARE_CLASS( ApplicationMenuPopup )
#define _ApplicationMenuPopup_
#endif
...
/* Deklaration of class : 'Application::MenuPopup' */
EW_DEFINE_FIELDS( ApplicationMenuPopup, ApplicationBaseMenuPopup )
  EW_OBJECT  ( CaptionText,     ViewsText )
  EW_OBJECT  ( CancelButton,    ComponentsTextButton )
EW_END_OF_FIELDS( ApplicationMenuPopup )

/* Virtual Method Table (VMT) for the class : 'Application::MenuPopup' */
EW_DEFINE_METHODS( ApplicationMenuPopup, ApplicationBaseMenuPopup )
...
EW_END_OF_METHODS( ApplicationMenuPopup )
