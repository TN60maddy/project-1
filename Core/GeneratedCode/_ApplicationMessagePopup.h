...
#ifndef _ApplicationMessagePopup_H
#define _ApplicationMessagePopup_H
...
/* Forward declaration of the class Application::MessagePopup */
#ifndef _ApplicationMessagePopup_
  EW_DECLARE_CLASS( ApplicationMessagePopup )
#define _ApplicationMessagePopup_
#endif
...
/* Deklaration of class : 'Application::MessagePopup' */
EW_DEFINE_FIELDS( ApplicationMessagePopup, ApplicationPopup )
  EW_OBJECT  ( Background,      ViewsRectangle )
  EW_OBJECT  ( CaptionText,     ViewsText )
  EW_OBJECT  ( MessageText,     ViewsText )
  EW_PROPERTY( Message,         XString )
EW_END_OF_FIELDS( ApplicationMessagePopup )

/* Virtual Method Table (VMT) for the class : 'Application::MessagePopup' */
EW_DEFINE_METHODS( ApplicationMessagePopup, ApplicationPopup )
...
EW_END_OF_METHODS( ApplicationMessagePopup )
...
#endif /* _ApplicationMessagePopup_H */
