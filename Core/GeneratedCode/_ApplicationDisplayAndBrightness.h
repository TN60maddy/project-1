...
#ifndef _ApplicationDisplayAndBrightness_H
#define _ApplicationDisplayAndBrightness_H
...
/* Forward declaration of the class Application::DisplayAndBrightness */
#ifndef _ApplicationDisplayAndBrightness_
  EW_DECLARE_CLASS( ApplicationDisplayAndBrightness )
#define _ApplicationDisplayAndBrightness_
#endif
...
/* Deklaration of class : 'Application::DisplayAndBrightness' */
EW_DEFINE_FIELDS( ApplicationDisplayAndBrightness, ApplicationSettingsPage )
  EW_OBJECT  ( InfoTip,         ComponentsInfoTip )
  EW_OBJECT  ( HorzSlider,      WidgetSetHorizontalSlider )
  EW_OBJECT  ( MinImage,        ViewsImage )
  EW_OBJECT  ( MaxImage,        ViewsImage )
  EW_OBJECT  ( HorizontalSliderConfig, WidgetSetHorizontalSliderConfig )
  EW_OBJECT  ( ConfirmButton,   ComponentsTextButton )
  EW_VARIABLE( initialBrightness, XInt32 )
EW_END_OF_FIELDS( ApplicationDisplayAndBrightness )

/* Virtual Method Table (VMT) for the class : 'Application::DisplayAndBrightness' */
EW_DEFINE_METHODS( ApplicationDisplayAndBrightness, ApplicationSettingsPage )
  ...
  EW_METHOD( onBack,            void )( ApplicationDisplayAndBrightness _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationDisplayAndBrightness )
...
#endif /* _ApplicationDisplayAndBrightness_H */
