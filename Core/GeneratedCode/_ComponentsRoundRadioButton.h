...
#ifndef _ComponentsRoundRadioButton_H
#define _ComponentsRoundRadioButton_H
...
/* Forward declaration of the class Components::RoundRadioButton */
#ifndef _ComponentsRoundRadioButton_
  EW_DECLARE_CLASS( ComponentsRoundRadioButton )
#define _ComponentsRoundRadioButton_
#endif
...
/* Deklaration of class : 'Components::RoundRadioButton' */
EW_DEFINE_FIELDS( ComponentsRoundRadioButton, ComponentsRoundTextButton )
  EW_PROPERTY( Outlet,          XRef )
  EW_PROPERTY( OutletSelector,  XInt32 )
  EW_PROPERTY( BgColorSelected, XColor )
  EW_PROPERTY( Selected,        XBool )
EW_END_OF_FIELDS( ComponentsRoundRadioButton )

/* Virtual Method Table (VMT) for the class : 'Components::RoundRadioButton' */
EW_DEFINE_METHODS( ComponentsRoundRadioButton, ComponentsRoundTextButton )
  ...
  EW_METHOD( onActivate,        void )( ComponentsRoundRadioButton _this, XObject 
    sender )
  EW_METHOD( OnSetOutletSelector, void )( ComponentsRoundRadioButton _this, XInt32 
    value )
EW_END_OF_METHODS( ComponentsRoundRadioButton )
...
#endif /* _ComponentsRoundRadioButton_H */
