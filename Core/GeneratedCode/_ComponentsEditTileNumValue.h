...
#ifndef _ComponentsEditTileNumValue_H
#define _ComponentsEditTileNumValue_H
...
/* Forward declaration of the class Components::EditTileNumValue */
#ifndef _ComponentsEditTileNumValue_
  EW_DECLARE_CLASS( ComponentsEditTileNumValue )
#define _ComponentsEditTileNumValue_
#endif
...
/* Deklaration of class : 'Components::EditTileNumValue' */
EW_DEFINE_FIELDS( ComponentsEditTileNumValue, ComponentsEditTile )
  EW_OBJECT  ( TextEditor,      ComponentsTextEditor )
EW_END_OF_FIELDS( ComponentsEditTileNumValue )

/* Virtual Method Table (VMT) for the class : 'Components::EditTileNumValue' */
EW_DEFINE_METHODS( ComponentsEditTileNumValue, ComponentsEditTile )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsEditTileNumValue _this, XSet aState )
  ...
  EW_METHOD( OnSetValue,        void )( ComponentsEditTile _this, XInt32 value )
  ...
  EW_METHOD( Save,              void )( ComponentsEditTileNumValue _this )
EW_END_OF_METHODS( ComponentsEditTileNumValue )
...
#endif /* _ComponentsEditTileNumValue_H */
