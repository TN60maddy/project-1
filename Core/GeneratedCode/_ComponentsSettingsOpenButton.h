...
#ifndef _ComponentsSettingsOpenButton_H
#define _ComponentsSettingsOpenButton_H
...
/* Forward declaration of the class Components::SettingsOpenButton */
#ifndef _ComponentsSettingsOpenButton_
  EW_DECLARE_CLASS( ComponentsSettingsOpenButton )
#define _ComponentsSettingsOpenButton_
#endif
...
/* Deklaration of class : 'Components::SettingsOpenButton' */
EW_DEFINE_FIELDS( ComponentsSettingsOpenButton, ComponentsSettingsButton )
  EW_OBJECT  ( IconBackground,  ViewsRectangle )
  EW_OBJECT  ( OpenImage,       ViewsImage )
  EW_PROPERTY( IconBgColor,     XColor )
EW_END_OF_FIELDS( ComponentsSettingsOpenButton )

/* Virtual Method Table (VMT) for the class : 'Components::SettingsOpenButton' */
EW_DEFINE_METHODS( ComponentsSettingsOpenButton, ComponentsSettingsButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsSettingsOpenButton _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsSettingsOpenButton _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( onActivate,        void )( ComponentsSettingsOpenButton _this, XObject 
    sender )
  EW_METHOD( OnSetCaption,      void )( ComponentsIconTextButton _this, XString 
    value )
EW_END_OF_METHODS( ComponentsSettingsOpenButton )
...
#endif /* _ComponentsSettingsOpenButton_H */
