...
#ifndef _ComponentsIconTextButton_H
#define _ComponentsIconTextButton_H
...
/* Forward declaration of the class Components::IconTextButton */
#ifndef _ComponentsIconTextButton_
  EW_DECLARE_CLASS( ComponentsIconTextButton )
#define _ComponentsIconTextButton_
#endif
...
/* Deklaration of class : 'Components::IconTextButton' */
EW_DEFINE_FIELDS( ComponentsIconTextButton, ComponentsTextButton )
  EW_OBJECT  ( Image,           ViewsImage )
  EW_PROPERTY( Icon,            ResourcesBitmap )
  EW_PROPERTY( IconColor,       XColor )
EW_END_OF_FIELDS( ComponentsIconTextButton )

/* Virtual Method Table (VMT) for the class : 'Components::IconTextButton' */
EW_DEFINE_METHODS( ComponentsIconTextButton, ComponentsTextButton )
  ...
  EW_METHOD( OnSetCaption,      void )( ComponentsIconTextButton _this, XString 
    value )
EW_END_OF_METHODS( ComponentsIconTextButton )
...
#endif /* _ComponentsIconTextButton_H */
