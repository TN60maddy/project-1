...
#ifndef _ComponentsPressureSettingButton_H
#define _ComponentsPressureSettingButton_H
...
/* Forward declaration of the class Components::PressureSettingButton */
#ifndef _ComponentsPressureSettingButton_
  EW_DECLARE_CLASS( ComponentsPressureSettingButton )
#define _ComponentsPressureSettingButton_
#endif
...
/* Deklaration of class : 'Components::PressureSettingButton' */
EW_DEFINE_FIELDS( ComponentsPressureSettingButton, ComponentsRoundRadioButton )
EW_END_OF_FIELDS( ComponentsPressureSettingButton )

/* Virtual Method Table (VMT) for the class : 'Components::PressureSettingButton' */
EW_DEFINE_METHODS( ComponentsPressureSettingButton, ComponentsRoundRadioButton )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsRoundButton _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsRoundRadioButton _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( onActivate,        void )( ComponentsRoundRadioButton _this, XObject 
    sender )
  EW_METHOD( OnSetOutletSelector, void )( ComponentsPressureSettingButton _this, 
    XInt32 value )
EW_END_OF_METHODS( ComponentsPressureSettingButton )
...
#endif /* _ComponentsPressureSettingButton_H */
