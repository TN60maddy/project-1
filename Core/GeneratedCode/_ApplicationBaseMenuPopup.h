...
#ifndef _ApplicationBaseMenuPopup_H
#define _ApplicationBaseMenuPopup_H
...
/* Forward declaration of the class Application::BaseMenuPopup */
#ifndef _ApplicationBaseMenuPopup_
  EW_DECLARE_CLASS( ApplicationBaseMenuPopup )
#define _ApplicationBaseMenuPopup_
#endif
...
/* Deklaration of class : 'Application::BaseMenuPopup' */
EW_DEFINE_FIELDS( ApplicationBaseMenuPopup, ApplicationPopup )
  EW_OBJECT  ( SimpleTouchHandler, CoreSimpleTouchHandler )
  EW_OBJECT  ( Background,      ViewsRectangle )
EW_END_OF_FIELDS( ApplicationBaseMenuPopup )

/* Virtual Method Table (VMT) for the class : 'Application::BaseMenuPopup' */
EW_DEFINE_METHODS( ApplicationBaseMenuPopup, ApplicationPopup )
...
EW_END_OF_METHODS( ApplicationBaseMenuPopup )

#ifdef __cplusplus
  }
#endif

#endif /* _ApplicationBaseMenuPopup_H */
