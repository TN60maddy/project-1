...
#ifndef _ComponentsKeyButton_H
#define _ComponentsKeyButton_H
...
/* Forward declaration of the class Components::KeyButton */
#ifndef _ComponentsKeyButton_
  EW_DECLARE_CLASS( ComponentsKeyButton )
#define _ComponentsKeyButton_
#endif
...
/* Deklaration of class : 'Components::KeyButton' */
EW_DEFINE_FIELDS( ComponentsKeyButton, ComponentsBaseButton )
  EW_OBJECT  ( KeyText,         ViewsText )
  EW_PROPERTY( Key,             XChar )
EW_END_OF_FIELDS( ComponentsKeyButton )

/* Virtual Method Table (VMT) for the class : 'Components::KeyButton' */
EW_DEFINE_METHODS( ComponentsKeyButton, ComponentsBaseButton )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsKeyButton _this, XSet aState )
...
EW_END_OF_METHODS( ComponentsKeyButton )
