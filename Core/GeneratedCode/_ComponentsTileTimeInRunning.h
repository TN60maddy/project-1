...
#ifndef _ComponentsTileTimeInRunning_H
#define _ComponentsTileTimeInRunning_H
...
/* Forward declaration of the class Components::TileTimeInRunning */
#ifndef _ComponentsTileTimeInRunning_
  EW_DECLARE_CLASS( ComponentsTileTimeInRunning )
#define _ComponentsTileTimeInRunning_
#endif
...
/* Deklaration of class : 'Components::TileTimeInRunning' */
EW_DEFINE_FIELDS( ComponentsTileTimeInRunning, ComponentsTileTime )
  EW_OBJECT  ( ProgressBar,     ComponentsProgressBar )
  EW_PROPERTY( RemainingOutlet, XRef )
  EW_PROPERTY( RemainingTime,   XInt32 )
  EW_PROPERTY( Progress,        XInt32 )
EW_END_OF_FIELDS( ComponentsTileTimeInRunning )

/* Virtual Method Table (VMT) for the class : 'Components::TileTimeInRunning' */
EW_DEFINE_METHODS( ComponentsTileTimeInRunning, ComponentsTileTime )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsTile _this, XSet aState )
...
EW_END_OF_METHODS( ComponentsTileTimeInRunning )
...
#endif /* _ComponentsTileTimeInRunning_H */
