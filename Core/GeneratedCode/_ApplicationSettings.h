...
EW_DEFINE_FIELDS( ApplicationSettings, NavigationPage )
  EW_OBJECT  ( Scrim,           ViewsRectangle )
  EW_OBJECT  ( Header,          ComponentsHeader )
  EW_OBJECT  ( PressureButton,  ComponentsSettingsButton )
  EW_OBJECT  ( AirBubbleDetectorButton, ComponentsSettingsButton )
  EW_OBJECT  ( DisplayButton,   ComponentsSettingsButton )
  EW_OBJECT  ( BolusRateButton, ComponentsSettingsButton )
  EW_OBJECT  ( KVOButton,       ComponentsSettingsButton )
  EW_OBJECT  ( GeneralButton,   ComponentsSettingsButton )
EW_END_OF_FIELDS( ApplicationSettings )

/* Virtual Method Table (VMT) for the class : 'Application::Settings' */
EW_DEFINE_METHODS( ApplicationSettings, NavigationPage )
