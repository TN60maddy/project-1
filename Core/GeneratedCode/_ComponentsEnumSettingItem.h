...
#ifndef _ComponentsEnumSettingItem_H
#define _ComponentsEnumSettingItem_H
...
/* Forward declaration of the class Components::EnumSettingItem */
#ifndef _ComponentsEnumSettingItem_
  EW_DECLARE_CLASS( ComponentsEnumSettingItem )
#define _ComponentsEnumSettingItem_
#endif
...
/* Deklaration of class : 'Components::EnumSettingItem' */
EW_DEFINE_FIELDS( ComponentsEnumSettingItem, ComponentsSettingItem )
  EW_OBJECT  ( ValueDisplay,    ComponentsEnumValueDisplay )
  EW_PROPERTY( Enum,            DeviceEnumClass )
  EW_PROPERTY( Value,           XInt32 )
EW_END_OF_FIELDS( ComponentsEnumSettingItem )

/* Virtual Method Table (VMT) for the class : 'Components::EnumSettingItem' */
EW_DEFINE_METHODS( ComponentsEnumSettingItem, ComponentsSettingItem )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsEnumSettingItem _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsEnumSettingItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsEnumSettingItem )
...
#endif /* _ComponentsEnumSettingItem_H */
