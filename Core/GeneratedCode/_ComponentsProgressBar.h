...
#ifndef _ComponentsProgressBar_H
#define _ComponentsProgressBar_H
...
/* Forward declaration of the class Components::ProgressBar */
#ifndef _ComponentsProgressBar_
  EW_DECLARE_CLASS( ComponentsProgressBar )
#define _ComponentsProgressBar_
#endif
...
/* Deklaration of class : 'Components::ProgressBar' */
EW_DEFINE_FIELDS( ComponentsProgressBar, ComponentsHorzValueBar )
EW_END_OF_FIELDS( ComponentsProgressBar )

/* Virtual Method Table (VMT) for the class : 'Components::ProgressBar' */
EW_DEFINE_METHODS( ComponentsProgressBar, ComponentsHorzValueBar )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsHorzValueBar _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsHorzValueBar _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsProgressBar )

#ifdef __cplusplus
  }
#endif

#endif /* _ComponentsProgressBar_H */
