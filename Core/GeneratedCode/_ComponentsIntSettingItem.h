...
#ifndef _ComponentsIntSettingItem_H
#define _ComponentsIntSettingItem_H
...
/* Forward declaration of the class Components::IntSettingItem */
#ifndef _ComponentsIntSettingItem_
  EW_DECLARE_CLASS( ComponentsIntSettingItem )
#define _ComponentsIntSettingItem_
#endif
...
/* Deklaration of class : 'Components::IntSettingItem' */
EW_DEFINE_FIELDS( ComponentsIntSettingItem, ComponentsSettingItem )
  EW_OBJECT  ( ValueDisplay,    ComponentsIntValueDisplay )
  EW_OBJECT  ( ValueRangeDisplay, ComponentsValueRangeDisplay )
...
EW_END_OF_FIELDS( ComponentsIntSettingItem )

/* Virtual Method Table (VMT) for the class : 'Components::IntSettingItem' */
EW_DEFINE_METHODS( ComponentsIntSettingItem, ComponentsSettingItem )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsIntSettingItem _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsIntSettingItem _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsIntSettingItem )
...
#endif /* _ComponentsIntSettingItem_H */
