...
#ifndef _ApplicationTimerPickerPopup_H
#define _ApplicationTimerPickerPopup_H
...
/* Forward declaration of the class Application::TimerPickerPopup */
#ifndef _ApplicationTimerPickerPopup_
  EW_DECLARE_CLASS( ApplicationTimerPickerPopup )
#define _ApplicationTimerPickerPopup_
#endif
...
/* Deklaration of class : 'Application::TimerPickerPopup' */
EW_DEFINE_FIELDS( ApplicationTimerPickerPopup, ApplicationInputPopup )
  EW_OBJECT  ( TimePicker,      ComponentsTimePicker )
EW_END_OF_FIELDS( ApplicationTimerPickerPopup )

/* Virtual Method Table (VMT) for the class : 'Application::TimerPickerPopup' */
EW_DEFINE_METHODS( ApplicationTimerPickerPopup, ApplicationInputPopup )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationTimerPickerPopup _this, XSet 
    aState )
  ...
  EW_METHOD( OnSetOutlet,       void )( ApplicationTimerPickerPopup _this, XRef 
    value )
EW_END_OF_METHODS( ApplicationTimerPickerPopup )
...
#endif /* _ApplicationTimerPickerPopup_H */
