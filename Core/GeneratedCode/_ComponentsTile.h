...
#ifndef _ComponentsTile_H
#define _ComponentsTile_H
...
/* Deklaration of class : 'Components::Tile' */
EW_DEFINE_FIELDS( ComponentsTile, ComponentsBaseTile )
  EW_OBJECT  ( IconImage,       ViewsImage )
  EW_PROPERTY( Icon,            ResourcesBitmap )
  EW_PROPERTY( EditIcon,        ResourcesBitmap )
  EW_PROPERTY( MinValue,        XInt32 )
  EW_PROPERTY( MaxValue,        XInt32 )
EW_END_OF_FIELDS( ComponentsTile )

/* Virtual Method Table (VMT) for the class : 'Components::Tile' */
EW_DEFINE_METHODS( ComponentsTile, ComponentsBaseTile )
...
EW_END_OF_METHODS( ComponentsTile )
