...
#ifndef _ComponentsDateTimeSettingItem_H
#define _ComponentsDateTimeSettingItem_H
...
/* Forward declaration of the class Components::DateTimeSettingItem */
#ifndef _ComponentsDateTimeSettingItem_
  EW_DECLARE_CLASS( ComponentsDateTimeSettingItem )
#define _ComponentsDateTimeSettingItem_
#endif
...
/* Deklaration of class : 'Components::DateTimeSettingItem' */
EW_DEFINE_FIELDS( ComponentsDateTimeSettingItem, ComponentsSettingItem )
  EW_OBJECT  ( ValueDisplay,    ComponentsDateTimeDisplay )
  EW_PROPERTY( Outlet,          XRef )
EW_END_OF_FIELDS( ComponentsDateTimeSettingItem )

/* Virtual Method Table (VMT) for the class : 'Components::DateTimeSettingItem' */
EW_DEFINE_METHODS( ComponentsDateTimeSettingItem, ComponentsSettingItem )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( ComponentsDateTimeSettingItem _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( ComponentsDateTimeSettingItem _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ComponentsDateTimeSettingItem )
...
#endif /* _ComponentsDateTimeSettingItem_H */
