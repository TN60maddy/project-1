...
#ifndef _ComponentsRoundIconButton_H
#define _ComponentsRoundIconButton_H
...
/* Forward declaration of the class Components::RoundIconButton */
#ifndef _ComponentsRoundIconButton_
  EW_DECLARE_CLASS( ComponentsRoundIconButton )
#define _ComponentsRoundIconButton_
#endif
...
/* Deklaration of class : 'Components::RoundIconButton' */
EW_DEFINE_FIELDS( ComponentsRoundIconButton, ComponentsRoundButton )
  EW_OBJECT  ( IconImage,       ViewsImage )
  EW_PROPERTY( Icon,            ResourcesBitmap )
  EW_PROPERTY( IconColor,       XColor )
EW_END_OF_FIELDS( ComponentsRoundIconButton )

/* Virtual Method Table (VMT) for the class : 'Components::RoundIconButton' */
EW_DEFINE_METHODS( ComponentsRoundIconButton, ComponentsRoundButton )
  ...
  EW_METHOD( UpdateViewState,   void )( ComponentsRoundIconButton _this, XSet aState )
...
EW_END_OF_METHODS( ComponentsRoundIconButton )
...
#endif /* _ComponentsRoundIconButton_H */
