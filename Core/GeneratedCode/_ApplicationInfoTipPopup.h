...
#ifndef _ApplicationInfoTipPopup_H
#define _ApplicationInfoTipPopup_H
...
/* Forward declaration of the class Application::InfoTipPopup */
#ifndef _ApplicationInfoTipPopup_
  EW_DECLARE_CLASS( ApplicationInfoTipPopup )
#define _ApplicationInfoTipPopup_
#endif
...
/* Deklaration of class : 'Application::InfoTipPopup' */
EW_DEFINE_FIELDS( ApplicationInfoTipPopup, ApplicationMessagePopup )
  EW_OBJECT  ( CloseButton,     ComponentsRoundIconButton )
EW_END_OF_FIELDS( ApplicationInfoTipPopup )

/* Virtual Method Table (VMT) for the class : 'Application::InfoTipPopup' */
EW_DEFINE_METHODS( ApplicationInfoTipPopup, ApplicationMessagePopup )
...
EW_END_OF_METHODS( ApplicationInfoTipPopup )
...
#endif /* _ApplicationInfoTipPopup_H */
