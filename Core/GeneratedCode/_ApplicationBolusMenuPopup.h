...
#ifndef _ApplicationBolusMenuPopup_H
#define _ApplicationBolusMenuPopup_H
...
/* Forward declaration of the class Application::BolusMenuPopup */
#ifndef _ApplicationBolusMenuPopup_
  EW_DECLARE_CLASS( ApplicationBolusMenuPopup )
#define _ApplicationBolusMenuPopup_
#endif
...
/* Deklaration of class : 'Application::BolusMenuPopup' */
EW_DEFINE_FIELDS( ApplicationBolusMenuPopup, ApplicationMenuPopup )
  EW_OBJECT  ( ProgramButton,   ComponentsMenuButton )
  EW_OBJECT  ( UseLastProgButton, ComponentsMenuButton )
  EW_OBJECT  ( ManualButton,    ComponentsMenuButton )
EW_END_OF_FIELDS( ApplicationBolusMenuPopup )

/* Virtual Method Table (VMT) for the class : 'Application::BolusMenuPopup' */
EW_DEFINE_METHODS( ApplicationBolusMenuPopup, ApplicationMenuPopup )
  ...
  EW_METHOD( UpdateViewState,   void )( ApplicationMenuPopup _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
  EW_METHOD( OnSetCaption,      void )( ApplicationMenuPopup _this, XString value )
  EW_METHOD( onClose,           void )( NavigationPage _this, XObject sender )
EW_END_OF_METHODS( ApplicationBolusMenuPopup )

#ifdef __cplusplus
  }
#endif

#endif /* _ApplicationBolusMenuPopup_H */
