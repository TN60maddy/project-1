...
#ifndef _ApplicationStatusBar_H
#define _ApplicationStatusBar_H
...
/* Forward declaration of the class Application::StatusBar */
#ifndef _ApplicationStatusBar_
  EW_DECLARE_CLASS( ApplicationStatusBar )
#define _ApplicationStatusBar_
#endif
...
/* Deklaration of class : 'Application::StatusBar' */
EW_DEFINE_FIELDS( ApplicationStatusBar, CoreGroup )
  EW_OBJECT  ( InfusionStateText, ViewsText )
  EW_OBJECT  ( TimeText,        ViewsText )
  EW_OBJECT  ( Outline,         CoreOutline )
  EW_OBJECT  ( Battery,         ComponentsBattery )
  EW_OBJECT  ( WifiIcon,        ViewsImage )
  EW_OBJECT  ( Timer,           CoreTimer )
  EW_OBJECT  ( time,            CoreTime )
EW_END_OF_FIELDS( ApplicationStatusBar )

/* Virtual Method Table (VMT) for the class : 'Application::StatusBar' */
EW_DEFINE_METHODS( ApplicationStatusBar, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationStatusBar )
