...
#ifndef _ApplicationDataAndTime_H
#define _ApplicationDataAndTime_H
...
/* Forward declaration of the class Application::DataAndTime */
#ifndef _ApplicationDataAndTime_
  EW_DECLARE_CLASS( ApplicationDataAndTime )
#define _ApplicationDataAndTime_
#endif
...
/* Deklaration of class : 'Application::DataAndTime' */
EW_DEFINE_FIELDS( ApplicationDataAndTime, ApplicationSettingsSubPage )
EW_END_OF_FIELDS( ApplicationDataAndTime )

/* Virtual Method Table (VMT) for the class : 'Application::DataAndTime' */
EW_DEFINE_METHODS( ApplicationDataAndTime, ApplicationSettingsSubPage )
  ...
  EW_METHOD( onBack,            void )( ApplicationSettingsSubPage _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationDataAndTime )

#ifdef __cplusplus
  }
#endif

#endif /* _ApplicationDataAndTime_H */
