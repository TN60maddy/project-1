...
EW_DEFINE_FIELDS( ApplicationPopup, NavigationPage )
  EW_PROPERTY( Type,            XEnum )
  EW_PROPERTY( ScrimColor,      XColor )
  EW_PROPERTY( FadeBackground,  XBool )
EW_END_OF_FIELDS( ApplicationPopup )

/* Virtual Method Table (VMT) for the class : 'Application::Popup' */
EW_DEFINE_METHODS( ApplicationPopup, NavigationPage )
