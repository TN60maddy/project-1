...
#ifndef _ApplicationAbout_H
#define _ApplicationAbout_H
...
/* Forward declaration of the class Application::About */
#ifndef _ApplicationAbout_
  EW_DECLARE_CLASS( ApplicationAbout )
#define _ApplicationAbout_
#endif
...
/* Deklaration of class : 'Application::About' */
EW_DEFINE_FIELDS( ApplicationAbout, ApplicationSettingsSubPage )
  EW_OBJECT  ( MfgDateTimeItem, ComponentsDateTimeSettingItem )
  EW_OBJECT  ( OutlineBackground, CoreOutline )
  ...
  EW_OBJECT  ( SerialNumberItem, ComponentsStringSettingItem )
  EW_OBJECT  ( NameItem,        ComponentsStringSettingItem )
  EW_OBJECT  ( ManufacturerItem, ComponentsStringSettingItem )
  EW_OBJECT  ( ModelNumberItem, ComponentsStringSettingItem )
  EW_OBJECT  ( FirmwareVersionItem, ComponentsStringSettingItem )
EW_END_OF_FIELDS( ApplicationAbout )

/* Virtual Method Table (VMT) for the class : 'Application::About' */
EW_DEFINE_METHODS( ApplicationAbout, ApplicationSettingsSubPage )
  ...
  EW_METHOD( onBack,            void )( ApplicationSettingsSubPage _this, XObject 
    sender )
EW_END_OF_METHODS( ApplicationAbout )
