...
{
  const XVariantOfPoint* data = EwGetVariantOf( aConstant, XVariantOfPoint );
  static const XPoint    zero = { 0, 0 };
  ...
  {
    const XPoint* v = (const XPoint*)EwGetBlobConstant((const XBlobLink*)data,
                                                        EW_BLOB_TYPE_POINT );
