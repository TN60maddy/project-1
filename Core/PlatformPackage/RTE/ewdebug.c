...
/* This internal function initializes the debug module functionality. */
void EwInitDebug( void )
{
  #ifdef EW_PRINT_PERF_COUNTERS
    PerfCounters = 0;
    ResetTime1   = 0;
...
/* This internal function de-initializes the debug module functionality. */
void EwDoneDebug( void )
{
}
...
*
*******************************************************************************/
const XRuntimeEnvironmentInfo* EwGetRuntimeEnvironmentInfo( void )
{
  static XRuntimeEnvironmentInfo info;
  info.Version = EW_RTE_VERSION;
  return &info;
}
  ...
  while ( *aFormat )
  {
    ...
    switch ( *aFormat++ )
    {
      ...
      case 'u' :
      {
        ...
        {
          unsigned long tmp = va_arg( marker, unsigned int );
