...
/* This internal function initializes the timer functionality. */
void EwInitTimers( void )
{
  Timers = 0;
}


/* This internal function de-initializes the timer functionality. */
void EwDoneTimers( void )
{
  /* Release all resources associated to still existing timers. */
  while ( Timers )
    EwDestroyTimer( Timers );
}
