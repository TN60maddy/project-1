...
{
  const XVariantOfRect* data = EwGetVariantOf( aConstant, XVariantOfRect );
  static const XRect    zero = {{ 0, 0 }, { 0, 0 }};
  ...
  {
    const XRect* v = (const XRect*)EwGetBlobConstant((const XBlobLink*)data,
                                                      EW_BLOB_TYPE_RECT );
